...
function lookup() {
  ...
  fetch("https://script.google.com/macros/s/AKfycbySI0FBLkyjJ5womXR2udT5B4LFsI08DMIru0Pl-OhdjBPXU1V8RRauHL7ajrejKvZXNA/exec", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ name, birth, phone })
  })
  .then(res => res.json())
  .then(data => {
    if (data.length === 0) {
